...
1. Clone the repo
   ```sh
   git clone https://github.com/Kayke-Fujinaka/Rocketshoes
   ```
2. Install packages
   ```sh
   npm install
...
Project Link: [https://github.com/Kayke-Fujinaka/Rocketshoes](https://github.com/Kayke-Fujinaka/Rocketshoes)
